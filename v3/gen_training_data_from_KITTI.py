...
# drive = '0027' #straight road forest (185 frames)
drive = '0028' #curved road forest (429 frames)
...
#big
np.save('/media/derm/06EF-127D1/TrainingData/KITTI_0028_scan1_100pts', scan1_cum)
np.save('/media/derm/06EF-127D1/TrainingData/KITTI_0028_scan2_100pts', scan2_cum)
np.save('/media/derm/06EF-127D1/TrainingData/KITTI_0028_ground_truth_100pts', soln_cum)
