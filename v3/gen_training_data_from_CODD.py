...
numShifts = 10
runLen = 100 #124 #max 125
ptsPerCell = 50
num_v = 5

# filename = 'C:/CODD/data/m1v7p7s769.hdf5' #straight line urban
filename = '/media/derm/06EF-127D/CODD/data/m10v11p6s30.hdf5' #wide road, palm trees, and traffic
# filename = '/media/derm/06EF-127D/CODD/data/m2v7p3s333.hdf5' #complex geometries


for vidx in range(num_v):

	# vidx = 1 #manually set vehicle index
...
#Ubuntu
np.save('/media/derm/06EF-127D/TrainingData/CODD_big_scan1_50pts', scan1_cum)
np.save('/media/derm/06EF-127D/TrainingData/CODD_big_scan2_50pts', scan2_cum)
np.save('/media/derm/06EF-127D/TrainingData/CODD_big_ground_truth_50pts', rand_cum)