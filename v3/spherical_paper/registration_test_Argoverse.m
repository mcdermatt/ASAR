...
scan1_fn = "D:/argoverse_benchmarks/urban_canyon/scan55.txt"; %works on 10, fails on 0
scan2_fn = "D:/argoverse_benchmarks/urban_canyon/scan56.txt";
...
offset = 0.2*randn();
tinit = rigid3d(eul2rotm([0,0,0]), [gt(55) + offset,0,0]);
