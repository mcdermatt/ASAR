...
%     lidar_rpy %for debug
    ...
    vals.lla0_combined = lla0_combined;
    vals.lla_ins_last = lla_ins_last;
    vals.vel0 = vel0;
    vals.rpy0 = rpy0;
    vals.dv0 = dv0;
    vals.qbn0 = qbn0;
%     vals.qbn_lidar = qbn_lidar;
    vals.msrk = msrk;
    vals.msrk1 = msrk1;
    vals.gpsmsr = gpsmsr;
    vals.lidarmsr = lidarmsr;
    vals.x_ins = x_ins;
    vals.xHatM_ins = xHatM_ins;
    vals.x_lidar = x_lidar;
    vals.x_lidar_cum = x_lidar_cum;
    vals.PM_ins = PM_ins;
    vals.PP_ins_last = PP_ins_last;
    vals.PM_combined = PM_combined;
    vals.gpsCnt = gpsCnt;
    vals.lidarCnt = lidarCnt;
    vals.PM_lidar_last = PM_lidar_last;
    vals.fuse_lidar = fuse_lidar;
    vals.fuse_gps = fuse_gps;
    vals.Qk200 = Qk200;
    %----------------------------------------------------------------
...
%     PM_combined = out.PM_combined;
    ...
    %only considering diagonal elements of each P block fixes negative eig bug
...
%             %WLS changes in vel ~~~~~~~~~~~
            ...
            dvel_lidar = vel_lidar - vel_lidar_last;
...
%     corr_ins_hist(i, :) =  corr_ins.';
    ...
    if gpsUpdated == 1
        ...
        xHatM_ins(1:9) = zeros(9,1);        % Reset error states  
    else
