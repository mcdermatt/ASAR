...
PM_combined = PP;               %init PM_combined value to PP
Ncol = 22;
...
%     msrk1 = [imuraw(i), imuraw(i, 2:end)].'; %for debug
    ...
    % GPS/INS solution
    [lla_ins, ned_lidar, lla_combined, vel, rpy, dv, qbn, xHatM_ins, xHatM_lidar, xHatM_combined, PP, gpsUpdated, lidarUpdated, gpsCnt, lidarCnt, gpsResUpd, PM_ins, PM_lidar, PM_combined, F200, Qk200] = ...
        ins_gps(lla0_ins, ned0_lidar, lla0_combined, lla_ins_last, vel0, rpy0, dv0, qbn0, qbn_lidar, msrk, msrk1, gpsmsr, lidarmsr, xHatM_ins, xHatM_lidar, xHatM_ins_cum, xHatM_lidar_cum, PP, PP_ins_last, PM_combined, gpsCnt, lidarCnt, t_last_lidar, PM_lidar_last, fuse_lidar, fuse_gps, F200, Qk200);
...
function [lla_ins, ned_lidar, lla_combined, vel, rpy, dv, qbn, xHatM_ins, xHatM_lidar, xHatM_combined, PP, gpsUpdated, lidarUpdated, gpsCnt, lidarCnt, gpsResUpd, PM_ins, PM_lidar, PM_combined, F200, Qk200] = ...
    ins_gps(lla0_ins, ned0_lidar, lla0_combined, lla_ins_last, vel0, rpy0, dv0, qbn0, qbn_lidar, msrk, msrk1, gpsmsr, lidarmsr, xHatM_ins, xHatM_lidar, xHatM_ins_cum, xHatM_lidar_cum, PP, PP_ins_last, PM_combined, gpsCnt, lidarCnt, t_last_lidar, PM_lidar_last, fuse_lidar, fuse_gps, F200, Qk200)
...
%     xHatM_lidar = lidarmsr(2:4).'; %was this-> wrong??
    xHatM_lidar = [lidarmsr(3), -lidarmsr(2), lidarmsr(4)].';
...
%         lla_ins = lla_lidar; %temp
        qbn = qbn_lidar; %temp - just update heading of INS to that of lidar 
%          ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
